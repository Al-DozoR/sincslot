...
@router_client_auth_login.post("/login", responses={
...
async def login_client(
    ...
    if client is None:
        logger.warning("Failed to get client by phone %s. Impossible to log in", login_input.phone)
        return JSONResponse(
    ...
    try:
        ...
        return JSONResponse(
            ...
            content=ClientErrorResponse(error=f"Failed to log in").model_dump()
        )
